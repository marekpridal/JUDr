...
(function($) {
  ...
  defaults = {
    ...
    inputs: {
      ...
      perPageText: 'Počet záznamů: ',
      recordCountText: 'Zobrazuji ',
      processingText: 'Načítání'
    },
    dataset: {
      ajax: false,
      ajaxUrl: null,
  ...
  function RecordsCount(obj, settings) {
    ...
    this.create = function() {
      ...
      if (recordsShown < recordsQueryCount && settings.features.paginate) {
        ...
        text += "<span class='dynatable-record-bounds'>" + (bounds[0] + 1) + " až " + bounds[1] + "</span> z ";
  ...
  function PaginationLinks(obj, settings) {
    ...
    this.create = function() {
      ...
      pageLinks += '<li><span>Stránky: </span></li>';
